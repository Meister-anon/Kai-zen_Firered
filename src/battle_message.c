...
static const u8 sText_PkmnMakesGroundMiss[] = _("{B_DEF_NAME_WITH_PREFIX} is in the air!\nGROUND moves can't hit it!");
...
const u8 *const gBattleStringsTable[] = {
    ...
    [STRINGID_PKMNSXCALLEDDOWNHAIL - 12]          = sText_PkmnsXCalledDownHail,
    [STRINGID_POKEMONBLOCKEDBALL - 12]            = sText_PokemonBlockedBall,
