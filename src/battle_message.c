...
static const u8 sText_AttackerHurtsPkmnWith[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_ATK_ABILITY}\nhurt {B_DEF_NAME_WITH_PREFIX}!");
...
static const u8 sText_AftermathDmg[] = _("{B_ATK_NAME_WITH_PREFIX} is hurt!"); //fix this 
