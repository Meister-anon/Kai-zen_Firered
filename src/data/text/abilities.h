...
static const u8 sMagmaArmorDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Prevents freezing and eggs hatch faster.");
...
static const u8 sArenaTrapDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Prevents the foe from fleeing.");
...
static const u8 sAngerPointDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Critical hits max Attack.");
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_ILLUMINATE] = sIlluminateDescription,  //increasd accuracy compoundn eyes boost
    ...
    [ABILITY_PRESSURE] = sPressureDescription,  //gave paralyze like effect, already updated description
    ...
    [ABILITY_TRUANT] = sTruantDescription,  //gave off turn healing
    ...
    [ABILITY_TANGLED_FEET] = sTangledFeetDescription,//no speed drop from paralysis or other speed drops
    [ABILITY_MOTOR_DRIVE] = sMotorDriveDescription,
    [ABILITY_RIVALRY] = sRivalryDescription,        //removed opposite gender stat drop
    ...
    [ABILITY_ANTICIPATION] = sAnticipationDescription,  //giving this and forwarn identified move one turn immunity, and reactiation on enemy switch
    ...
    [ABILITY_MULTITYPE] = sMultitypeDescription,    //essentially does nothing since made species arceus mystery type and give global stab, won't use tablets can make new description
    [ABILITY_FLOWER_GIFT] = sFlowerGiftDescription,
    [ABILITY_BAD_DREAMS] = sBadDreamsDescription,
    [ABILITY_PICKPOCKET] = sPickpocketDescription,  //gave small damage reduction for contact moves
    ...
    [ABILITY_DEFEATIST] = sDefeatistDescription,    //added multiple bonus effects, guaranteed run and speed boost? double check util.c  etc.
    ...
    [ABILITY_COMPETITIVE] = sCompetitiveDescription,    //very situational, consider adding status1 as extra trigger effect so special atk guts+
    ...
    [ABILITY_WIMP_OUT] = sWimpOutDescription,   //doing something with these..
    ...
    [ABILITY_COMATOSE] = sComatoseDescription,  //added end turn healing, 
    ...
    [ABILITY_HI_PRESSURE] = sHipressureDescription, //add paralyze like effect, description updated already
