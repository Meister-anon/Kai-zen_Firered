...
static const u8 sSixthSenseDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Prevents loss of accuracy.\nImmune to effects of being confused.");
...
static const u8 sArenaTrapDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("If grounded stops the foe from fleeing.\nAlso drops their speed.");
