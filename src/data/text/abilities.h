...
static const u8 sSturdyDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Negates 1-hit KO attacks.");
static const u8 sDampDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Prevents self-destruction.");
...
static const u8 sColorChangeDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Changes type to foe's move.");
...
static const u8 sShadowTagDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Prevents the foe's escape.");
static const u8 sRoughSkinDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Hurts to touch.");
static const u8 sWonderGuardDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("“Super effective” hits.");
static const u8 sLevitateDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Not hit by GROUND attacks.");
...
static const u8 sClearBodyDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Prevents ability reduction.");
static const u8 sNaturalCureDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Heals upon switching out.");
static const u8 sLightningRodDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Draws electrical moves.");
static const u8 sSereneGraceDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Promotes added effects.");
...
static const u8 sHugePowerDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Raises ATTACK.");
...
static const u8 sMagmaArmorDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Prevents freezing.");
static const u8 sWaterVeilDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Prevents burns.");
static const u8 sMagnetPullDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Traps STEEL-type POKéMON.");
...
static const u8 sForecastDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Changes with the weather.");
...
static const u8 sGutsDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Ups ATTACK if suffering.");
static const u8 sMarvelScaleDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Ups DEFENSE if suffering.");
...
static const u8 sArenaTrapDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Prevents fleeing.");
...
static const u8 sTangledFeetDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Ups evasion if confused.");
static const u8 sMotorDriveDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Electricity raises Speed.");
static const u8 sRivalryDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Powers up against rivals.");
static const u8 sSteadfastDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Flinching raises Speed.");
...
static const u8 sAngerPointDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Critical hits raise Attack.");
static const u8 sUnburdenDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Using a hold item ups Speed.");
static const u8 sHeatproofDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Heat and burn protection.");
...
static const u8 sDownloadDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Adjusts power favorably.");
...
static const u8 sQuickFeetDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Ups Speed if suffering.");
static const u8 sNormalizeDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Moves become Normal-type.");
...
static const u8 sStallDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Always moves last.");
static const u8 sTechnicianDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Boosts weaker moves.");
static const u8 sLeafGuardDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Blocks status in sunshine.");
static const u8 sKlutzDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Can't use hold items.");
...
static const u8 sAftermathDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Fainting damages the foe.");
static const u8 sAnticipationDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Senses dangerous moves.");
static const u8 sForewarnDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Determines a foe's move.");
static const u8 sUnawareDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Ignores stat changes.");
static const u8 sTintedLensDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Ups “not very effective”.");
static const u8 sFilterDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Weakens “supereffective”.");
...
static const u8 sFriskDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Checks a foe's item.");
static const u8 sRecklessDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Boosts moves with recoil.");
static const u8 sMultitypeDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Changes type to its Plate.");
...
static const u8 sPickpocketDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Steals the foe's held item.");
...
static const u8 sDefiantDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Lowered stats up Attack.");
static const u8 sDefeatistDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Gives up at half HP.");
...
static const u8 sWeakArmorDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Its stats change when hit.");
...
static const u8 sRattledDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Raises Speed when scared.");
static const u8 sMagicBounceDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Reflects status moves.");
static const u8 sSapSipperDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Grass increases Attack.");
...
static const u8 sAromaVeilDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Prevents limiting of moves.");
...
static const u8 sCompetitiveDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Lowered stats up Sp. Atk.");
...
static const u8 sGrassPeltDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Ups Defense in grass.");
...
static const u8 sWaterCompactionDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Water boosts Defense.");
static const u8 sMercilessDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Criticals poisoned foes.");
static const u8 sShieldsDownDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Shell breaks at half HP.");
...
static const u8 sBeastBoostDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("KOs boost best stat.");
...
static const u8 sNeuroforceDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Ups “supereffective”.");
...
static const u8 sGulpMissileDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("If hit, spits prey from sea.");
...
static const u8 sPunkRockDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Ups and resists sound.");
...
static const u8 sIceFaceDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Take a free hit. Hail renews.");
...
static const u8 sSteelySpiritDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Boosts ally's Steel moves.");
...
static const u8 sUnknownPowerDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("A mysterious ability from the unown dimension,\doubles power when with unown");
