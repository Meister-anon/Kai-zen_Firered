...
static const u8 sInnerFocusDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Focuses intensely prevents flinching.\nAlso prevents critical hits.");
...
static const u8 sSteadfastDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Flinching and “Super effective” hits\nraise speed.");
