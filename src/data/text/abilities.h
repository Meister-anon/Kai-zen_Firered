...
static const u8 sKlutzDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Can't use hold items, but reduces\nphysical dmg. Also prevents recoil damage.");
...
static const u8 sDefiantDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Ups Attack if stats lowered.\And if suffering from status.");
...
static const u8 sCompetitiveDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Ups Sp. Atk. if stats lowered.\And if suffering from status.");
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_KLUTZ] = sKlutzDescription,        //added small damage reduction and rock head immunity to recoil, idea klutzy used to taking hits
    ...
    [ABILITY_FOREWARN] = sForewarnDescription,  //should work how I want,for ai make ability check to not use fakeout if have said ability,still need setup reactivation
    ...
    [ABILITY_MULTITYPE] = sMultitypeDescription,    //essentially does nothing since made species arceus mystery type and give global stab, won't use tablets made new description
    ...
    [ABILITY_TELEPATHY] = sTelepathyDescription,  //don't know if this does anything in gen 3, pretty sure partner attacks didn't hurt teamate unless specifically targetted at them anyway
