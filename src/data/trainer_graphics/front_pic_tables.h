const struct MonCoords gTrainerFrontPicCoords[] =
{
    ...
    [TRAINER_PIC_RS_AROMA_LADY]         = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_RS_RUIN_MANIAC]        = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_INTERVIEWER]           = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_RS_TUBER_F]            = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_RS_TUBER_M]            = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_RS_COOLTRAINER_M]      = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_RS_COOLTRAINER_F]      = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_HEX_MANIAC]            = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_RS_LADY]               = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_RS_BEAUTY]             = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_RICH_BOY]              = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_RS_POKEMANIAC]         = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_RS_SWIMMER_M]          = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_RS_BLACK_BELT]         = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_GUITARIST]             = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_KINDLER]               = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_RS_CAMPER]             = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_BUG_MANIAC]            = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_RS_PSYCHIC_M]          = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_RS_PSYCHIC_F]          = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_RS_GENTLEMAN]          = {.size = 8, .y_offset = 1},
    ...
    [TRAINER_PIC_RS_YOUNGSTER]          = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_CHAMPION_STEVEN]       = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_RS_FISHERMAN]          = {.size = 8, .y_offset = 1},
    ...
    [TRAINER_PIC_RS_BIRD_KEEPER]        = {.size = 8, .y_offset = 1},
    ...
    [TRAINER_PIC_RS_SWIMMER_F]          = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_RS_PICNICKER]          = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_RS_TWINS]              = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_RS_SAILOR]             = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_COLLECTOR]             = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_WALLY]                 = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_RS_BRENDAN_1]          = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_RS_MAY_1]              = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_RS_POKEMON_BREEDER_M]  = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_RS_POKEMON_BREEDER_F]  = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_RS_POKEMON_RANGER_M]   = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_RS_POKEMON_RANGER_F]   = {.size = 8, .y_offset = 1},
    ...
    [TRAINER_PIC_RS_LASS]               = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_RS_BUG_CATCHER]        = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_RS_HIKER]              = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_RS_YOUNG_COUPLE]       = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_OLD_COUPLE]            = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_RS_SIS_AND_BRO]        = {.size = 8, .y_offset = 1},
    ...
    [TRAINER_PIC_RS_BRENDAN_2]          = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_RS_MAY_2]              = {.size = 8, .y_offset = 1},
