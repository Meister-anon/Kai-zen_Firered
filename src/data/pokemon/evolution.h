...
{  // REMOVED specific map evolution cause don't know how to doit, replaced with general map evolution with mapsec
    ...
    [SPECIES_CATERPIE] = {{EVO_LEVEL, 7, SPECIES_METAPOD}
                          //,{EVO_MOVE, MOVE_COCOON, SPECIES_METAPOD} //Idea for change bug middle evos make feel unique  vsonic
                          },
    ...
    [SPECIES_ABRA] = {{EVO_LEVEL, 21, SPECIES_KADABRA}},
   ...
   // [SPECIES_ALAKAZAM]              = {{EVO_MEGA_EVOLUTION, ITEM_ALAKAZITE, SPECIES_ALAKAZAM_MEGA}},
    ...
    [SPECIES_SLOWPOKE] = {{EVO_LEVEL, 37, SPECIES_SLOWBRO},//lower this
   ...
   // [SPECIES_GYARADOS]              = {{EVO_MEGA_EVOLUTION, ITEM_GYARADOSITE, SPECIES_GYARADOS_MEGA}},
    ...
    [SPECIES_KABUTO] = {{EVO_LEVEL, 34, SPECIES_KABUTOPS}}, //34 for duration of stone age 3.4 mil,needed lower since can get earlier
   ...
   // [SPECIES_MEWTWO]                = {{EVO_MEGA_EVOLUTION, ITEM_MEWTWONITE_X, SPECIES_MEWTWO_MEGA_X},
    ...
    [SPECIES_CROCONAW] = {{EVO_LEVEL, 30, SPECIES_FERALIGATOR}},
    ...
    [SPECIES_TOGETIC] = {{EVO_ITEM, ITEM_SHINY_STONE, SPECIES_TOGEKISS},
                            {EVO_LEVEL_DAY, 40, SPECIES_TOGEKISS}},
   ...
   // [SPECIES_AMPHAROS]              = {{EVO_MEGA_EVOLUTION, ITEM_AMPHAROSITE, SPECIES_AMPHAROS_MEGA}},
    ...
    [SPECIES_SUNKERN] = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_SUNFLORA},
                          {EVO_LEVEL_DAY, 24, SPECIES_SUNFLORA}},
   ...
   // [SPECIES_HERACROSS]             = {{EVO_MEGA_EVOLUTION, ITEM_HERACRONITE, SPECIES_HERACROSS_MEGA}},
    ...
    [SPECIES_URSARING] = {{EVO_LEVEL_NIGHT, 50, SPECIES_URSALUNA}},
   ...
   // [SPECIES_HOUNDOOM]              = {{EVO_MEGA_EVOLUTION, ITEM_HOUNDOOMINITE, SPECIES_HOUNDOOM_MEGA}},
    ...
    [SPECIES_TYROGUE] = {{EVO_LEVEL_FEMALE, 15, SPECIES_HITMONCHAN},
                                       ...
                                       {EVO_MOVE, MOVE_RAPID_SPIN, SPECIES_HITMONTOP}},
    [SPECIES_SMOOCHUM] = {{EVO_LEVEL, 24, SPECIES_JYNX}},// prob change above to evo move
   ...
   // [SPECIES_SWAMPERT]              = {{EVO_MEGA_EVOLUTION, ITEM_SWAMPERTITE, SPECIES_SWAMPERT_MEGA}},
    ...
    [SPECIES_NOSEPASS] = {{EVO_SPECIFIC_TYPE_IN_PARTY, TYPE_ELECTRIC, SPECIES_PROBOPASS}}, 
  ...
  //  [SPECIES_ALTARIA]               = {{EVO_MEGA_EVOLUTION, ITEM_ALTARIANITE, SPECIES_ALTARIA_MEGA}},
   ...
   // [SPECIES_ABSOL]                 = {{EVO_MEGA_EVOLUTION, ITEM_ABSOLITE, SPECIES_ABSOL_MEGA}},
    [SPECIES_SHUPPET] = {{EVO_LEVEL, 37, SPECIES_BANETTE}}, //mon is better so think can keep at this level
 ...
 //   [SPECIES_LUCARIO]               = {{EVO_MEGA_EVOLUTION, ITEM_LUCARIONITE, SPECIES_LUCARIO_MEGA}},
  ...
  //  [SPECIES_GALLADE]               = {{EVO_MEGA_EVOLUTION, ITEM_GALLADITE, SPECIES_GALLADE_MEGA}},
    ...
    [SPECIES_TRANQUILL] = {{EVO_LEVEL_MALE, 32, SPECIES_UNFEZANT_M},
                                       {EVO_LEVEL_FEMALE, 32, SPECIES_UNFEZANT_F}},
   ...
   // [SPECIES_KARRABLAST] = {{EVO_LEVEL_KARRABLAST, 20, SPECIES_ESCAVALIER}},
    ...
    [SPECIES_LITWICK] = {{EVO_LEVEL, 32, SPECIES_LAMPENT}},
   ...
   // [SPECIES_SHELMET] = {{EVO_LEVEL_SHELMET, 20, SPECIES_ACCELGOR}},
    [SPECIES_MIENFOO] = {{EVO_LEVEL, 39, SPECIES_MIENSHAO}},
    [SPECIES_GOLETT] = {{EVO_LEVEL, 43, SPECIES_GOLURK}},
    [SPECIES_PAWNIARD] = {{EVO_LEVEL, 37, SPECIES_BISHARP}},
    [SPECIES_RUFFLET] = {{EVO_LEVEL, 39, SPECIES_BRAVIARY}},
    [SPECIES_VULLABY] = {{EVO_LEVEL, 39, SPECIES_MANDIBUZZ}},
    ...
    [SPECIES_LITLEO] = { {EVO_LEVEL_MALE, 35, SPECIES_PYROAR_M},
                                       {EVO_LEVEL_FEMALE, 35, SPECIES_PYROAR_F} },
   ...
   // [SPECIES_POIPOLE] = {{EVO_MOVE, MOVE_DRAGON_PULSE, SPECIES_NAGANADEL}},
    ...
    [SPECIES_PONYTA_GALARIAN] = {{EVO_LEVEL, 35, SPECIES_RAPIDASH_GALARIAN}}, //shouldnt this be galarian rapidash?
    [SPECIES_SLOWPOKE_GALARIAN] = {{EVO_ITEM, ITEM_NONE, SPECIES_SLOWBRO_GALARIAN}, 
                                       {EVO_ITEM, ITEM_NONE, SPECIES_SLOWKING_GALARIAN}},
    [SPECIES_FARFETCHD_GALARIAN] = {{EVO_LEVEL, 40, SPECIES_SIRFETCHD}},
    ...
    [SPECIES_SNEASEL_HISUIAN] = {{EVO_LEVEL_FEMALE, 35, SPECIES_SNEASLER}},
    ...
    [SPECIES_PUMPKABOO_SMALL] = {{EVO_LEVEL, 28, SPECIES_GOURGEIST_SMALL}},
    [SPECIES_PUMPKABOO_LARGE] = {{EVO_LEVEL, 28, SPECIES_GOURGEIST_LARGE}},
    [SPECIES_PUMPKABOO_SUPER] = {{EVO_LEVEL, 28, SPECIES_GOURGEIST_SUPER}},
    ...
    [SPECIES_BASCULIN_WHITE_STRIPED] = {{EVO_LEVEL_DUSK, 25, SPECIES_BASCULEGION}}, //WORK OUT something for this, it evolved from reoil before
};
