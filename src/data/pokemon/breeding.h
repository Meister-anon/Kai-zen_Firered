...
const struct Breeding gBreedingTable[NUM_SPECIES][FORMS_PER_MON] =
{  //this is all for breeding so adjust as needed reasoning well may not need think I already had another function that could
    //read the base forms from the evolved version
