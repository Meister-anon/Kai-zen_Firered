...
static bool8 TrySetTrainerBattleQuestLogEvent(u16, const u16 *); //ok good removing log for rematch doesn't affect normal trainer logs
...
void sub_81113E4(void) //important don't konw what thsi does
{
