...
const struct CompressedSpriteSheet gBattleAnimPicTable[] =
{
    ...
    { gBattleAnimSpriteGfx_Acupressure, 0x0200, ANIM_TAG_ACCUPRESSURE },
...
const struct CompressedSpritePalette gBattleAnimPaletteTable[] =
{
    ...
    { gBattleAnimSpritePal_Acupressure, ANIM_TAG_ACCUPRESSURE },
...
static void (*const sScriptCmdTable[])(void) =
{
    ...
    ScriptCmd_invisible,
    ScriptCmd_visible,
    ScriptCmd_doublebattle_2D, //believe unused
    ScriptCmd_doublebattle_2E, //beieve unused
    ScriptCmd_stopsound,
