...
const u8 *const gMonIconTable[] = {
    ...
    [SPECIES_UNFEZANT_M] = gMonIcon_Unfezant,
    ...
    [SPECIES_PYROAR_M] = gMonIcon_Pyroar,
    ...
    //  [SPECIES_REGIELEKI]                       = gMonIcon_Regieleki,
      ...
      [SPECIES_UNFEZANT_F] = gMonIcon_Unfezant_F,
      [SPECIES_PYROAR_F] = gMonIcon_PyroarF,
...
const u8 gMonIconPaletteIndices[] = {
    ...
    [SPECIES_ORBEETLE] = 0,
    [SPECIES_NICKIT] = 0,
    [SPECIES_THIEVUL] = 0, //edit front sprite
