...
//removed shedinja & meganium from list because they will get custom abillities for boss.
...
void SetPlayerBulbasaurBall(void) {
    VarSet(VAR_TEMP_2, sRandomSpecies[Random() % NELEMS(sRandomSpecies)]);
}
