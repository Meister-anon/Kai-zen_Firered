...
//7-8-21 realized tms/item data was broken, using wrong uses, commented out, and reset using vanilla
//will eventually add back on to list as I figure it out.
...
//emerald redefines to match graphics
#define ITEM_OVAL_STONE 375
#define ITEM_PRISM_SCALE 376
#define ITEM_PROTECTOR 377
...
//Power Items
#define ITEM_POWER_BRACER 383
#define ITEM_POWER_BELT 384
#define ITEM_POWER_LENS 385
#define ITEM_POWER_BAND 386
#define ITEM_POWER_ANKLET 387
#define ITEM_POWER_WEIGHT 388
//Fossils
#define ITEM_SAIL_FOSSIL 389
#define ITEM_JAW_FOSSIL 390
#define ITEM_PLUME_FOSSIL 391
#define ITEM_COVER_FOSSIL 392
#define ITEM_SKULL_FOSSIL 393
#define ITEM_ARMOR_FOSSIL 394
//etc.
#define ITEM_WHIPPED_DREAM 395
#define ITEM_SACHET 396
...
// Emerald
#define ITEM_MAGMA_EMBLEM 398
#define ITEM_OLD_SEA_MAP 399
...
//#define IS_POKEMON_ITEM2(item) ((item) > ITEM_SAPPHIRE && (item) < ITEM_SEA_INCENSE)  //second set of evo items
...
//sigh, can't figure out how to fix second set of use items, it breaks tms
//so I'll just reorder the damn list ..

//sigh  worse that didn't have anything to do with the problem.
