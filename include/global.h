...
struct BattleTowerData // Leftover from R/S
{
    ...
    /*0x03E4, 0x0494*/ u8 firstMonNickname[10]; // nickname of the first pokemon in the player's battle tower party
...
struct SaveBlock2
{
    ...
    /*0x014*/ u16 optionsTextSpeed:3; // OPTIONS_TEXT_SPEED_[SLOW/MID/FAST]     //don't know/remember if need to raise number, frame is on 5 but has 20 options
    /*0x014*/// u16 optionsMoveSpeed:2; // potentially new option for move speed normal/faster
...
#define BERRY_TREES_COUNT  128 //do i need that many?
