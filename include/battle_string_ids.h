...
#define STRINGID_SAFETYGOOGLESPROTECTED 521
...
#define STRINGID_CONFIRMFORGETMOVE 611 //TEXT for when flying is no longer vulnerable to ground 
...
#define BATTLESTRINGS_COUNT     STRINGID_CONFIRMFORGETMOVE
