...
//extern EWRAM_DATA struct ItemSlot gUnknown_02039F80[3]; //is unused according to Deokishisu is gMartPurchaseHistory leftover from ruby/saph used for shop tv show
